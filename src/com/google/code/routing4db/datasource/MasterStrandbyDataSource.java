...
public class MasterStrandbyDataSource extends AbstractDataSource implements InitializingBean {
	 ...
	 * 
	 * The default implementation handles DataSource instances and data source names (to be resolved via a {@link #setDataSourceLookup DataSourceLookup})
	 * 
	 * @param dataSource the data source value object as specified in the {@link #setTargetDataSources targetDataSources} map
	...
	/**
	 * Set the DataSourceLookup implementation to use for resolving data source name Strings in the {@link #setTargetDataSources targetDataSources} map.
	 * Default is a {@link JndiDataSourceLookup}, allowing the JNDI names of application server DataSources to be specified directly.
	 */
